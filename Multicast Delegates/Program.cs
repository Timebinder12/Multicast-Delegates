namespace assignment8ex1
{
    class Program
    {
        ...
        {
            SunDelegate sunDelegate1 = new SunDelegate(HereComesTheSun.chorus);
            sunDelegate1 += HereComesTheSun.chorus2;
            sunDelegate1 += HereComesTheSun.verse1;
            sunDelegate1 += HereComesTheSun.verse2;
            sunDelegate1 += HereComesTheSun.verse3;
            sunDelegate1 += HereComesTheSun.end;
